...
reshape long temp weight_cc weight_panel Int_month InterviewD InterviewM InterviewY Relationship_HH_head Born_in_US PIAT_math Family_income parIncome parSpIncome parSpOthIncome Family_net_worth reason_noninterview, i(id) j(year)
...
label define vl_race_ethnicity   1 "Black"  2 "Hispanic"  3 "Mixed Race (Non-Hispanic)"  4 "Non-Black / Non-Hispanic"
label values race_ethnicity vl_race_ethnicity

label define vl_race   1 "White" 2 "Black or African American" 3 "American Indian, Eskimo, or Aleut" 4 "Asian or Pacific Islander" 5 "Something else? (SPECIFY)" 0 "No information"
label values race vl_race

label define vl_ethnicity   0 "Not Hispanic"  1 "Hispanic"
label values ethnicity vl_ethnicity
